...
class TestBits < Minitest::Test
  def test_returns_array_without_block
    ...
    assert_instance_of Array, "\xAA".bits(scan_order: :lsb)
  end
  ...
  def test_array_content_msb
    assert_equal [true, false, true, false, true, false, true, false], "\xAA".bits(scan_order: :msb)
  end
